...
@Slf4j
@AllArgsConstructor
public class TextPatternCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check '{}' contains inner text match pattern: '{}'", locator.toString(), pattern);
    ...
    public String toString() {
        return "contains text match pattern '" + pattern + "'";
    }
}
