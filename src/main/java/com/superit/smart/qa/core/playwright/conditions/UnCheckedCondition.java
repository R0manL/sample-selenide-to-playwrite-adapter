...
@Slf4j
public class UnCheckedCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check '{}' has unchecked.",  locator.toString());
        assertThat(locator).not().isChecked(new LocatorAssertions.IsCheckedOptions().setTimeout(timeout));
    }

    @Override
    public String toString() {
        return "has unchecked";
    }
