...
public class BoxEditableModalWrapper extends ModalWrapper {
    private static final WebElm MODAL_ROOT_ELM = $("control-it-box-editable-modal");

    public BoxEditableModalWrapper() {
