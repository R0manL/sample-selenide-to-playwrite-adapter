...
@Slf4j
@AllArgsConstructor
public class ExactTextCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check '{}' has exact text: {}", locator.toString(), expectedText);
        assertThat(locator).hasText(expectedText, new LocatorAssertions.HasTextOptions()
    ...
    public String toString() {
        return "has exact text '" + expectedText + "'";
    }
