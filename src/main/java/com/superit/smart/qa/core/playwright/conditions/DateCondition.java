...
public class DateCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        ...
        log.debug("Check '{}' contains date: '{}'", locator.toString(), expDate);
        assertThat(locator).containsText(expDate, new LocatorAssertions.ContainsTextOptions()
    ...
    public String toString() {
        return "contains date '" + convertDateToStringInFormat(expectedDate, DatePattern.UI_DATE_FORMAT) + "'";
    }
}
