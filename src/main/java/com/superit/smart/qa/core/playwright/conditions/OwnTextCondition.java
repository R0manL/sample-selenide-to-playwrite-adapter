...
@Slf4j
@AllArgsConstructor
public class OwnTextCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check '{}' contains own text (ignore case): '{}'", locator.toString(), expectedText);
    ...
    public String toString() {
        return "contains own text (ignore case) '" + expectedText + "'";
    }
}
