...
@Slf4j
@AllArgsConstructor
public class ExactTextsIgnoreCaseCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check '{}' has exact texts: {}", locator.toString(), expectedTexts);
        assertThat(locator).hasText(expectedTexts, new LocatorAssertions.HasTextOptions()
    ...
    public String toString() {
        return "have exact texts '" + expectedTexts + "'";
    }
}
