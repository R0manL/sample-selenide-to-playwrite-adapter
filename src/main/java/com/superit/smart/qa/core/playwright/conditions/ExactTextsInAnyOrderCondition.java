...
@Slf4j
@AllArgsConstructor
public class ExactTextsInAnyOrderCondition implements Condition {
    ...
    private void verify(WebElm webElm, double timeout) {
        ...
        log.debug("Check '{}' has exact inner texts (ignore case, any order):'{}'", elmsLocator.toString(), texts);
    ...
    public String toString() {
        return "has exact texts (ignore case, any order)'" + texts + "'";
    }
}
