...
public class ValueCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check elm: '{}', has value: '{}'", locator.toString(), expectedValue);
        assertThat(locator).hasValue(expectedValue, new LocatorAssertions.HasValueOptions().setTimeout(timeout));
    }

    @Override
    public String toString() {
        return "has value '" + expectedValue;
    }
}
