...
@Slf4j
@AllArgsConstructor
public class InputPlaceholderCondition implements Condition {
    ...
    private void verify(Locator locator, double timeout) {
        log.debug("Check input: '{}' has 'placeholder' by regex: '{}'", locator.toString(), value);
        assertThat(locator).hasAttribute("placeholder", value, new LocatorAssertions.HasAttributeOptions().setTimeout(timeout));
    }

    @Override
    public String toString() {
        return "'placeholder' has value " + value;
    }
}
